...
-- AddForeignKey
ALTER TABLE "Attachment" ADD CONSTRAINT "Attachment_uplodedById_fkey" FOREIGN KEY ("uplodedById") REFERENCES "User"("userId") ON DELETE RESTRICT ON UPDATE CASCADE;
