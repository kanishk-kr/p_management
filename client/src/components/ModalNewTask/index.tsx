...
const ModalNewTask = ({isOpen,onClose,id=null}: Props) => {
    ...
    const selectStyles="mb-4 block w-full rounded border border-grey-300 px-3 py-2 dark:border-dark-tertiary dark:bg-dark-tertiary dark:text-white dark:focus:outline-none"
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} name="Create New Task">
        ...
        onSubmit={(e)=>{
            ...
            {id===null &&(
                <input type="text" className={inputStyles} placeholder="Project Id" value={projectId} onChange={(e)=>setProjectId(e.target.value)}/> 
            )}
