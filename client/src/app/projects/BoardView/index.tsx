...
const Task=({task}:TaskProps)=>{
    ...
    return(
        ...
        ${isDragging?"opacity-50":"opacity100"}`}>
            ...
            <div className='p-4 md:p-6'>
                <div className='flex items-start justify-between '>
                    ...
                    <button className='flex h-6 w-4 flex-shrink-0 item-center jaustify-center dark:text-neutral-500'>
                        <EllipsisVertical size={26}/>
                    </button>
                </div>
                ...
                <div className='mt-3 flex items-center justify-between'>
                    <div className='flex -space-x-[6px] overflow-hidden'>
                        {task.assignee &&(
                            ...
                            width={30}
                            height={30}
                            className='h-8 w-8 rounded-full border-2 border-white objext-cover dark:border-dark-secondary'/>
                        )}
                        {task.author &&(
                            <Image 
